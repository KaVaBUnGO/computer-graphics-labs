...
public class DrawUtil {
  ...
  public static void DrowLine(int x1, int y1, int x2, int y2, CartesianImage image) {
  ...
  public static void Brez(int x1, int y1, int x2, int y2, CartesianImage image, Color color) {
    int temp = 0;
